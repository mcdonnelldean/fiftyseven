...
internals.switchFootprint = 'seventykeys:4.5mm-switch';
...
internals.switch = `
  (module FOOTPRINT (layer F.Cu) (tedit 5D250269) (tstamp 5D30EDA7)
    ...
    (fp_circle (center 0 0) (end 0 -1) (layer F.Fab) (width 0.12))
    (fp_line (start 2.25 2.25) (end 2.25 -2.25) (layer F.Fab) (width 0.12))
    (fp_line (start -2.25 2.25) (end -2.25 -2.25) (layer F.Fab) (width 0.12))
    (fp_line (start -2.25 2.25) (end 2.25 2.25) (layer F.Fab) (width 0.12))
    (fp_line (start -2.25 -2.25) (end 2.25 -2.25) (layer F.Fab) (width 0.12))
...
internals.bezel = 1.5;
internals.xKeySize = (100 - 2*internals.bezel)/13;
internals.yKeySize = 8;

internals.offsetsForPosition = function (row, col) {

    // offset the row with asdf an extra half a key
    const xOffset = 100 + internals.bezel + internals.xKeySize/2 + (row === 2 ? internals.xKeySize/2 : 0);

    const yOffset = 150 - internals.yKeySize*4.5 - 1.5;
